...
INSERT INTO users (id, username, password, bio, profile_picture, date_joined, role) VALUES

(1, 'alex_wright', 'Adm!n@2023', 'Platform administrator. Keeping the community safe and thriving.', 'https://i.pravatar.cc/150?img=1', '2023-01-01 08:00:00', 'admin'),

(2, 'maya_stone', 'Myst!c99xA', 'Fantasy fiction and poetry lover. Published author of 3 novels.', 'https://i.pravatar.cc/150?img=2', '2023-01-08 14:30:00', 'writer'),
(3, 'liam_foster', 'Li@mFos23', 'Sci-fi and thriller reviewer. Bookworm and coffee addict.', 'https://i.pravatar.cc/150?img=3', '2023-01-10 10:00:00', 'writer'),
(4, 'sophia_lane', 'SLane@2k3', 'Librarian by day, mystery writer by night.', 'https://i.pravatar.cc/150?img=12', '2023-01-15 14:00:00', 'writer'),
(5, 'noah_brooks', 'No@hBr0ks', 'Sports journalist and weekend hiker. Writing about life outdoors.', 'https://i.pravatar.cc/150?img=5', '2023-01-18 08:45:00', 'writer'),
(6, 'henry_shaw', 'HSha!w567', 'Military historian. Published author of three books.', 'https://i.pravatar.cc/150?img=17', '2023-01-22 10:10:00', 'writer'),
(7, 'harper_bell', 'HBel!23xQ', 'Children book illustrator and author. Bringing stories to life.', 'https://i.pravatar.cc/150?img=20', '2023-01-25 09:50:00', 'writer'),
(8, 'ella_grant', 'EGra@nt22', 'Environmental activist and nature photographer.', 'https://i.pravatar.cc/150?img=22', '2023-01-28 14:45:00', 'writer'),
(9, 'luna_scott', 'LuSc@tt99', 'Romance novelist and bookstagram creator.', 'https://i.pravatar.cc/150?img=24', '2023-02-01 16:30:00', 'writer'),
(10, 'zoe_morgan', 'ZMorg@n11', 'Psychologist and self-help book author.', 'https://i.pravatar.cc/150?img=26', '2023-02-04 10:40:00', 'writer'),
(11, 'lily_baker', 'LBak@r789', 'Romance and drama screenwriter. Coffee shop regular.', 'https://i.pravatar.cc/150?img=28', '2023-02-07 09:30:00', 'writer'),
(12, 'penelope_gray', 'PGr@y456', 'Art critic and museum curator. Living for aesthetics.', 'https://i.pravatar.cc/150?img=32', '2023-02-10 15:00:00', 'writer'),
(13, 'victoria_lewis', 'VLew!s21', 'Corporate lawyer and legal advice columnist.', 'https://i.pravatar.cc/150?img=34', '2023-02-13 12:40:00', 'writer'),
(14, 'aurora_young', 'AYou@ng5', 'Astrophysics PhD student and science writer.', 'https://i.pravatar.cc/150?img=36', '2023-02-16 14:20:00', 'writer'),
(15, 'violet_martinez', 'VM@rt567', 'Poet and short story writer. Words are my world.', 'https://i.pravatar.cc/150?img=48', '2023-02-19 15:10:00', 'writer'),
(16, 'iris_clark', 'ICl@rk88', 'Graphic novelist and comic art creator.', 'https://i.pravatar.cc/150?img=50', '2023-02-22 12:00:00', 'writer'),
(17, 'ruby_wilson', 'RWil@s99', 'Pediatrician and parenting blogger.', 'https://i.pravatar.cc/150?img=52', '2023-02-25 14:20:00', 'writer'),
(18, 'claire_moore', 'CMoo@r77', 'Art teacher and painting workshop host.', 'https://i.pravatar.cc/150?img=56', '2023-02-28 10:00:00', 'writer'),
(19, 'flora_williams', 'FWil@m44', 'Environmental journalist and activist.', 'https://i.pravatar.cc/150?img=58', '2023-03-03 09:50:00', 'writer'),
(20, 'pearl_davis', 'PDav!s33', 'Vintage fashion collector and style blogger.', 'https://i.pravatar.cc/150?img=62', '2023-03-06 12:30:00', 'writer'),
(21, 'vera_rodriguez', 'VRod@r55', 'Translator and literary critic.', 'https://i.pravatar.cc/150?img=64', '2023-03-09 15:00:00', 'writer'),
(22, 'celeste_brown', 'CBro@n66', 'Astrologer and spiritual wellness blogger.', 'https://i.pravatar.cc/150?img=68', '2023-03-12 08:10:00', 'writer'),
(23, 'meadow_jones', 'MJon@s77', 'Herbalist and natural remedies blogger.', 'https://i.pravatar.cc/150?img=70', '2023-03-15 11:10:00', 'writer'),
(24, 'eden_wilson', 'EWil@n88', 'Homeschooling parent and educational content creator.', 'https://i.pravatar.cc/150?img=72', '2023-03-18 12:20:00', 'writer'),
(25, 'storm_davies', 'SDav@s22', 'Meteorologist and weather science writer.', 'https://i.pravatar.cc/150?img=74', '2023-03-21 15:30:00', 'writer'),
(26, 'lake_brown', 'LBro@n55', 'Wildlife photographer and conservation blogger.', 'https://i.pravatar.cc/150?img=84', '2023-03-24 09:30:00', 'writer'),
(27, 'crest_navarro', 'CNav@r44', 'Naval officer turned memoir writer.', 'https://i.pravatar.cc/150?img=86', '2023-03-27 08:20:00', 'writer'),
(28, 'terra_miller', 'TMil@r99', 'Geologist and science fiction author.', 'https://i.pravatar.cc/150?img=87', '2023-03-30 14:40:00', 'writer'),
(29, 'luna_hayes', 'LHay@s11', 'Night sky photographer and space blogger.', 'https://i.pravatar.cc/150?img=89', '2023-04-02 12:20:00', 'writer'),
(30, 'star_thomas', 'STho@s33', 'Science teacher and STEM education blogger.', 'https://i.pravatar.cc/150?img=91', '2023-04-05 11:00:00', 'writer'),
(31, 'flux_martin', 'FMar@n77', 'Quantum computing researcher and tech blogger.', 'https://i.pravatar.cc/150?img=95', '2023-04-08 10:50:00', 'writer'),
(32, 'byte_rodriguez', 'BRod@z88', 'Blockchain developer and crypto writer.', 'https://i.pravatar.cc/150?img=97', '2023-04-11 09:00:00', 'writer'),
(33, 'prism_anderson', 'PAnd@s22', 'Photography teacher and color theory writer.', 'https://i.pravatar.cc/150?img=106', '2023-04-14 14:40:00', 'writer'),
(34, 'lens_cooper', 'LCoo@r55', 'Cinematographer and film blogger.', 'https://i.pravatar.cc/150?img=107', '2023-04-17 09:00:00', 'writer'),
(35, 'cut_harrison', 'CHar@s99', 'Film editor and narrative structure analyst.', 'https://i.pravatar.cc/150?img=109', '2023-04-20 10:40:00', 'writer'),
(36, 'reel_harris', 'RHar@s44', 'Independent filmmaker and script consultant.', 'https://i.pravatar.cc/150?img=110', '2023-04-23 15:00:00', 'writer'),
(37, 'james_reed', 'JRee@d77', 'Podcast host and journalist covering climate change.', 'https://i.pravatar.cc/150?img=11', '2023-04-26 10:30:00', 'writer'),
(38, 'oscar_thomas', 'OTho@s11', 'Retired teacher now writing historical fiction.', 'https://i.pravatar.cc/150?img=41', '2023-04-29 09:10:00', 'writer'),
(39, 'finn_white', 'FWhi@t66', 'Software architect and technical writer.', 'https://i.pravatar.cc/150?img=43', '2023-05-02 10:00:00', 'writer'),
(40, 'hazel_harris', 'HHar@s55', 'Journalist covering arts and culture.', 'https://i.pravatar.cc/150?img=44', '2023-05-05 14:30:00', 'writer'),
(41, 'jasper_lee', 'JLee@s33', 'Outdoor survival guide author and former soldier.', 'https://i.pravatar.cc/150?img=65', '2023-05-08 09:30:00', 'writer'),


(42, 'sara_hill', 'Sara@H123', 'Love exploring ideas. Philosophy major turned data scientist.', 'https://i.pravatar.cc/150?img=4', '2023-01-12 11:20:00', 'user'),
(43, 'emma_cole', 'EmC0@le77', 'UX designer and amateur watercolor artist.', 'https://i.pravatar.cc/150?img=6', '2023-01-16 16:00:00', 'user'),
(44, 'ava_martin', 'AvaMar@t8', 'Fitness enthusiast and healthy living advocate.', 'https://i.pravatar.cc/150?img=8', '2023-01-20 07:30:00', 'user'),
(45, 'ethan_ross', 'ERoss@123', 'Full-stack developer browsing for good reads.', 'https://i.pravatar.cc/150?img=9', '2023-01-23 12:00:00', 'user'),
(46, 'isabella_day', 'IDay@9876', 'Travel enthusiast and aspiring blogger.', 'https://i.pravatar.cc/150?img=10', '2023-01-26 09:45:00', 'user'),
(47, 'william_carr', 'WCar@5543', 'Economist and policy wonk. Loves numbers and graphs.', 'https://i.pravatar.cc/150?img=13', '2023-01-29 09:00:00', 'user'),
(48, 'benjamin_fox', 'BFox@2211', 'Amateur astronomer and science enthusiast.', 'https://i.pravatar.cc/150?img=15', '2023-02-01 08:20:00', 'user'),
(49, 'charlotte_kim', 'CKim@3344', 'Fashion lover and sustainable living advocate.', 'https://i.pravatar.cc/150?img=16', '2023-02-04 15:40:00', 'user'),
(50, 'amelia_west', 'AWest@112', 'Yoga enthusiast and mindfulness student.', 'https://i.pravatar.cc/150?img=18', '2023-02-07 07:00:00', 'user'),
(51, 'lucas_price', 'LPri@8899', 'Indie game fan and pixel art enthusiast.', 'https://i.pravatar.cc/150?img=19', '2023-02-10 13:30:00', 'user'),
(52, 'mason_ward', 'MWar@4455', 'Home chef and food lover.', 'https://i.pravatar.cc/150?img=21', '2023-02-13 12:20:00', 'user'),
(53, 'jackson_wood', 'JWoo@6677', 'Cybersecurity student and CTF enthusiast.', 'https://i.pravatar.cc/150?img=23', '2023-02-16 11:15:00', 'user'),
(54, 'aiden_cook', 'ACoo@9911', 'Music lover and hobbyist guitarist.', 'https://i.pravatar.cc/150?img=25', '2023-02-19 08:00:00', 'user'),
(55, 'carter_james', 'CJam@3322', 'Political science student and debate lover.', 'https://i.pravatar.cc/150?img=27', '2023-02-22 14:00:00', 'user'),
(56, 'ryan_adams', 'RAda@1199', 'Stock market follower and personal finance reader.', 'https://i.pravatar.cc/150?img=29', '2023-02-25 11:50:00', 'user'),
(57, 'chloe_evans', 'CEva@7788', 'Language student and polyglot wannabe.', 'https://i.pravatar.cc/150?img=30', '2023-02-28 13:00:00', 'user'),
(58, 'daniel_hughes', 'DHug@5566', 'Sports fan and fantasy football player.', 'https://i.pravatar.cc/150?img=31', '2023-03-03 08:10:00', 'user'),
(59, 'sebastian_clark', 'SCla@2244', 'Marine biology student and ocean enthusiast.', 'https://i.pravatar.cc/150?img=33', '2023-03-06 10:20:00', 'user'),
(60, 'jack_walker', 'JWal@8833', 'DIY hobbyist and home improvement learner.', 'https://i.pravatar.cc/150?img=35', '2023-03-09 09:00:00', 'user'),
(61, 'leo_king', 'LKin@4411', 'Entrepreneur exploring startup ideas.', 'https://i.pravatar.cc/150?img=37', '2023-03-12 11:00:00', 'user'),
(62, 'grace_wright', 'GWri@9922', 'Nursing student and healthcare reader.', 'https://i.pravatar.cc/150?img=38', '2023-03-15 08:30:00', 'user'),
(63, 'eli_harris', 'EHar@7711', 'Photography enthusiast and documentary lover.', 'https://i.pravatar.cc/150?img=39', '2023-03-18 16:00:00', 'user'),
(64, 'scarlett_allen', 'SAlle@334', 'Interior design student and decor lover.', 'https://i.pravatar.cc/150?img=40', '2023-03-21 12:30:00', 'user'),
(65, 'nora_jackson', 'NJac@5577', 'Vegan lifestyle enthusiast and recipe collector.', 'https://i.pravatar.cc/150?img=42', '2023-03-24 13:50:00', 'user'),
(66, 'levi_grant', 'LGra@8844', 'Mechanical engineering student.', 'https://i.pravatar.cc/150?img=45', '2023-03-27 08:00:00', 'user'),
(67, 'stella_thompson', 'STho@1122', 'Nutrition and wellness enthusiast.', 'https://i.pravatar.cc/150?img=46', '2023-03-30 11:20:00', 'user'),
(68, 'hudson_garcia', 'HGar@6699', 'Adventure sports fan and outdoor reader.', 'https://i.pravatar.cc/150?img=47', '2023-04-02 09:40:00', 'user'),
(69, 'miles_robinson', 'MRob@3388', 'Jazz enthusiast and music history reader.', 'https://i.pravatar.cc/150?img=49', '2023-04-05 10:30:00', 'user'),
(70, 'elliot_davis', 'EDav@7766', 'Data science student and ML enthusiast.', 'https://i.pravatar.cc/150?img=51', '2023-04-08 09:00:00', 'user'),
(71, 'max_taylor', 'MTay@4422', 'Philosophy student and ethics reader.', 'https://i.pravatar.cc/150?img=53', '2023-04-11 11:00:00', 'user'),
(72, 'ivy_anderson', 'IAnd@9955', 'Gardening hobbyist and plant lover.', 'https://i.pravatar.cc/150?img=54', '2023-04-14 08:30:00', 'user'),
(73, 'cole_jackson', 'CJac@2277', 'Basketball fan and sports reader.', 'https://i.pravatar.cc/150?img=55', '2023-04-17 16:00:00', 'user'),
(74, 'eli_johnson', 'EJoh@1188', 'Urban planning student and city enthusiast.', 'https://i.pravatar.cc/150?img=57', '2023-04-20 13:30:00', 'user'),
(75, 'august_brown', 'ABro@5599', 'Philosophy reader and existentialism fan.', 'https://i.pravatar.cc/150?img=59', '2023-04-23 11:20:00', 'user'),
(76, 'daisy_jones', 'DJon@8866', 'Event planning enthusiast and lifestyle reader.', 'https://i.pravatar.cc/150?img=60', '2023-04-26 14:40:00', 'user'),
(77, 'theo_miller', 'TMil@3311', 'Physics student and science explainer fan.', 'https://i.pravatar.cc/150?img=61', '2023-04-29 08:00:00', 'user'),
(78, 'felix_garcia', 'FGar@7744', 'Biotech enthusiast and science reader.', 'https://i.pravatar.cc/150?img=63', '2023-05-02 10:10:00', 'user'),
(79, 'wren_harris', 'WHar@2255', 'Digital marketing student.', 'https://i.pravatar.cc/150?img=66', '2023-05-05 13:00:00', 'user'),
(80, 'atlas_johnson', 'AJoh@9988', 'World traveler and language exchange fan.', 'https://i.pravatar.cc/150?img=67', '2023-05-08 10:40:00', 'user'),
(81, 'river_smith', 'RSmi@4466', 'Environmental engineering student.', 'https://i.pravatar.cc/150?img=69', '2023-05-11 14:50:00', 'user'),
(82, 'blaze_miller', 'BMil@7733', 'Action film fan and stunt enthusiast.', 'https://i.pravatar.cc/150?img=71', '2023-05-14 09:00:00', 'user'),
(83, 'fox_taylor', 'FTay@1166', 'Extreme sports fan and adventure reader.', 'https://i.pravatar.cc/150?img=73', '2023-05-17 08:40:00', 'user'),
(84, 'dawn_thomas', 'DTho@5522', 'Early childhood education student.', 'https://i.pravatar.cc/150?img=75', '2023-05-20 10:00:00', 'user'),
(85, 'jade_morrison', 'JMor@8877', 'Gemology student and jewelry design enthusiast.', 'https://i.pravatar.cc/150?img=76', '2023-05-23 13:40:00', 'user'),
(86, 'ray_white', 'RWhi@3344', 'Radio listener and podcast enthusiast.', 'https://i.pravatar.cc/150?img=77', '2023-05-26 09:20:00', 'user'),
(87, 'brook_harris', 'BHar@6611', 'Freshwater ecology enthusiast.', 'https://i.pravatar.cc/150?img=78', '2023-05-29 14:00:00', 'user'),
(88, 'cliff_martin', 'CMar@9977', 'Rock climbing hobbyist and nature reader.', 'https://i.pravatar.cc/150?img=79', '2023-06-01 11:20:00', 'user'),
(89, 'sage_garcia', 'SGar@2288', 'Herbalism and ayurveda student.', 'https://i.pravatar.cc/150?img=80', '2023-06-04 08:00:00', 'user'),
(90, 'vale_rodriguez', 'VRod@7755', 'Mountaineering enthusiast and geography reader.', 'https://i.pravatar.cc/150?img=81', '2023-06-07 12:30:00', 'user'),
(91, 'bay_nguyen', 'BNgu@4499', 'Marine conservation supporter.', 'https://i.pravatar.cc/150?img=82', '2023-06-10 10:50:00', 'user'),
(92, 'glen_johnson', 'GJoh@1133', 'Forester and wilderness enthusiast.', 'https://i.pravatar.cc/150?img=83', '2023-06-13 15:10:00', 'user'),
(93, 'moor_smith', 'MSmi@6688', 'Anthropology student and cultural reader.', 'https://i.pravatar.cc/150?img=85', '2023-06-16 13:00:00', 'user'),
(94, 'sol_patel', 'SPat@3355', 'Solar energy enthusiast and clean tech fan.', 'https://i.pravatar.cc/150?img=88', '2023-06-19 10:00:00', 'user'),
(95, 'nova_anderson', 'NAnd@7722', 'Astrophotography hobbyist.', 'https://i.pravatar.cc/150?img=90', '2023-06-22 09:40:00', 'user'),
(96, 'comet_jackson', 'CJac@1177', 'Space exploration enthusiast.', 'https://i.pravatar.cc/150?img=92', '2023-06-25 14:20:00', 'user'),
(97, 'orbit_white', 'OWhi@5544', 'Aerospace engineering student.', 'https://i.pravatar.cc/150?img=93', '2023-06-28 08:00:00', 'user'),
(98, 'arc_harris', 'AHar@8811', 'Electrical engineering student and IoT hobbyist.', 'https://i.pravatar.cc/150?img=94', '2023-07-01 13:30:00', 'user'),
(99, 'pixel_garcia', 'PGar@2266', 'Digital art fan and creative enthusiast.', 'https://i.pravatar.cc/150?img=96', '2023-07-04 15:10:00', 'user'),
(100, 'chip_lee', 'CLee@9933', 'Hardware fan and tech review reader.', 'https://i.pravatar.cc/150?img=98', '2023-07-07 12:40:00', 'user'),
(101, 'node_johnson', 'NJoh@4477', 'Backend development learner.', 'https://i.pravatar.cc/150?img=99', '2023-07-10 10:00:00', 'user'),
(102, 'wire_brown', 'WBro@7711', 'Network enthusiast and cybersecurity reader.', 'https://i.pravatar.cc/150?img=100', '2023-07-13 14:30:00', 'user'),
(103, 'amp_scott', 'ASco@3388', 'Electronics hobbyist and Arduino tinkerer.', 'https://i.pravatar.cc/150?img=60', '2023-07-16 08:00:00', 'user'),
(104, 'volt_jones', 'VJon@6622', 'Renewable energy supporter and green reader.', 'https://i.pravatar.cc/150?img=61', '2023-07-19 11:20:00', 'user'),
(105, 'watt_wilson', 'WWil@1155', 'Energy policy reader and analyst fan.', 'https://i.pravatar.cc/150?img=63', '2023-07-22 13:00:00', 'user'),
(106, 'frame_jackson', 'FJac@8844', 'Video editing enthusiast and YouTube fan.', 'https://i.pravatar.cc/150?img=67', '2023-07-25 12:20:00', 'user'),
(107, 'kay_nguyen', 'KNgu@5511', 'Literature lover and avid reader.', 'https://i.pravatar.cc/150?img=29', '2023-07-28 10:30:00', 'user'),
(108, 'drew_patel', 'DPat@2299', 'Technology and culture enthusiast.', 'https://i.pravatar.cc/150?img=30', '2023-07-31 09:00:00', 'user'),
(109, 'quinn_foster', 'QFos@7766', 'Creative writing student and book lover.', 'https://i.pravatar.cc/150?img=31', '2023-08-03 14:00:00', 'user'),
(110, 'blake_morgan', 'BMor@3322', 'History enthusiast and museum visitor.', 'https://i.pravatar.cc/150?img=32', '2023-08-06 11:30:00', 'user');
